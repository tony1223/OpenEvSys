...
function generate_translations() {
    ...
    foreach ($languages as $lkey => $language) {
        ...
        //die(var_dump($path));
        //mkdir( APPROOT . "translate" . DIRECTORY_SEPARATOR . "translated\php\\" . $language);
        //mkdir( APPROOT . "translate" . DIRECTORY_SEPARATOR . "translated\js\\" . $language);
        //mkdir( $path );
...
function get_translations_array() {
    ...
    */
    ...
    $content = file_get_contents("translation_zh_tw.json");
